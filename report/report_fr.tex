...
\hypersetup{
  ...
  pdfauthor={Zeroual Dhia Eddine, Nadia Kerraouch}
}
...
{\large\textcolor{darkgray}{Projet de Fin d'Études en Pharmacie}}\\[1.5cm]
...
\begin{minipage}{0.45\textwidth}
  \raggedright
  \textbf{Développeur et ML Engineer}\\
...
\begin{minipage}{0.45\textwidth}
  \raggedleft
  \textbf{Projet de fin d'études de}\\
...
\subsection{Source}
Le jeu de données brut a été fourni par l'équipe clinique. Les données ont été collectées manuellement à partir des dossiers des patients dans un seul centre d'oncologie. Chaque ligne de la feuille de calcul brute correspond à une cure de chimiothérapie pour un patient. Les données ont été enregistrées dans un document Google Sheets et exportées sous forme de fichier CSV nommé \texttt{Collect Data Onco Lab AI - Feuille 2.csv}.
